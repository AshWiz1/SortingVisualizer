...
class App extends Component
{
  ...
  render()  
  {
    return (
      <div className = "App">
        <Header changespeed = {this.changespeed} stop = {this.stop} sortapp = {this.sortapp} setflag = {this.setflag} createarray = {this.createarray}/>
        <div className = "barcontainer" style={{display : 'flex', flexDirection : 'row', justifyContent : 'center'}}>
